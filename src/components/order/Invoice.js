    ...
    return (
        <Document>
            <Page style={styles.body}>
                ...
                <Text style={styles.title}>Tech eShop</Text>
                <Text style={styles.author}>Tech eShop</Text>
                ...
                <Text style={styles.text}>
                    <Text>Date: {'               '}
                        {new Date(order.paymentIntent.createdAt * 1000).toLocaleString()}
                    </Text>
                    {"\n"}
                    <Text>Order Id: {'         '}
